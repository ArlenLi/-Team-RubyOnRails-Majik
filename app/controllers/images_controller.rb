...
class ImagesController < ApplicationController
  before_action :authenticate_user!, only: [:create, :new, :destroy, :share, :index, :shareIndex, :edit, :changeFormat, :reEdit, :view, :cleartrash, :restore, :share, :trash, :trashbin, :download, :saveToDB, :save]
